...
/*
  ...
  */
    ...
    function toProjectivePoint(uint256 x0, uint256 y0) internal pure
    ...
    function isZeroCurve(uint256 x0, uint256 y0) internal pure
        returns(bool isZero)
    {
        if(x0 == 0 && y0 == 0) {
            return true;
    ...
    function twiceProj(uint256 x0, uint256 y0, uint256 z0) internal pure
        returns(uint256 x1, uint256 y1, uint256 z1)
    {
        uint256 t;
        uint256 u;
    ...
    function addProj(uint256 x0, uint256 y0, uint256 z0,
                     uint256 x1, uint256 y1, uint256 z1) internal pure
    ...
    function addProj2(uint256 v, uint256 u0, uint256 u1,
                      uint256 t1, uint256 t0) internal pure
        returns(uint256 x2, uint256 y2, uint256 z2)
    {
        uint256 u;
        uint256 u2;
    ...
    function twice(uint256 x0, uint256 y0) internal pure
        returns(uint256 x1, uint256 y1)
    {
        uint256 z0;
